...
def _train_one_batch(episode,batch_size,epoch,solution,problems_knn):
    ...
    while not done:
        if current_step == 0:
            ...
            selected_teacher, prob, probs, selected_student = model2(problems_knn, env.selected_node_list, solution, current_step)  # 更新被选择的点和概率
...
def _train_one_knn_batch(episode,batch_size,budget):
    ...
    ## env.raw_data_tours[episode:episode + batch_size] = env.solution
